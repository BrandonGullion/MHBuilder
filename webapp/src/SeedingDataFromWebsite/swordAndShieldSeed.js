...
for (let i = 0; i < trArray.length; i++) {
    ...
    const getRampageSkills = (cell) => {
        ...
        if (listItems.length === 0) {
            ...
            let prepString = `${listItems[0].innerText}/${listItems[1].innerText}/${listItems[2].innerText}`;
    ...
    if (trArray[i].cells.length === 8) {
        ...
        getRarity(trArray[i].cells.item(5));
        getRampageSkills(trArray[i].cells.item(6));
    }
}
